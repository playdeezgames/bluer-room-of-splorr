Public Interface ICharacter
    ...
    Function CreateEquipSlot(initializer As EquipSlotInitializer) As IEquipSlot
    ...
    Sub AdvanceDialog()
    Function CreateDialog(Optional initializer As DialogInitializer = Nothing) As IDialog
    Function FindTopicByNoun(noun As String) As ITopic
    Function CreateTopic(
                        topicName As String,
                        Optional initializer As TopicInitializer = Nothing) As ITopic
