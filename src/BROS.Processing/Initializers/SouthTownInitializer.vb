...
Friend Module SouthTownInitializer
    ...
    Private Sub InitializeTempleGuard(character As ICharacter)
        ...
        character.SetGreeting("The guard says ""The temple has a dress code. Corsets are required. Fishnets are optional, but highly encouraged. High heels are alway nice, especially shiny red ones. I could loan you a pair.""")
    End Sub
End Module
